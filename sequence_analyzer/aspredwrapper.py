...
def parse_arguments():
    ...
    parser.add_argument('--infpath', 
                       type=str,
                       default='/Users/joeyw/Documents/UCB/Summer_2026/aspredFE/aspredINF',
...
def run_prediction(model_filename, input_csv_name):
    ...
    # '/Users/joeyw/Documents/UCB/Summer_2026/aspredFE/aspredINF'
    
    
    absolute_model_file_folder = os.path.join(MODELPATH, model_filename)
    # Becomes: /Users/joeyw/.../aspredINF/foldername

    print(f"Executing inference using weights file: {absolute_model_file_folder}")

    subprocess.run([
        'uv', 'run', 'python', os.path.join(INFPATH, 'run_new_set.py'), 
        '--model_path', absolute_model_file_folder, 
